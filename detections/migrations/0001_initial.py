# Generated by Django 2.2.5 on 2019-09-18 16:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detection_request', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='detections.DetectionRequest')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='detections.DetectableObject')),
                ('detection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='detections.DetectionResult')),
            ],
            options={
